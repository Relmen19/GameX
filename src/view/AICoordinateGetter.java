...
public class AICoordinateGetter<privte> implements ICoordinateGetter {
    ...
    public Point coordinateGetter(final Field field) throws InvalidPointException {
        ...
        if(field.getFigure(new Point(0, 0)) == null && field.getFigure(new Point(2, 2)) == null) return new Point(0, 0);
        else if(field.getFigure(new Point(0, 0)) == Figure.O && field.getFigure(new Point(2, 2)) == null) return new Point(2, 2);
        else if (field.getFigure(new Point(0, 0)) == Figure.O && field.getFigure(new Point(2, 2)) == Figure.X) {

            if(field.getFigure(new Point(0, 2)) == Figure.X && field.getFigure(new Point(2, 0)) == null) {
                if(field.getFigure(new Point(1, 2)) == null) return new Point(1, 2);
                ...
                else if(field.getFigure(new Point(1, 0)) == Figure.X) {
                    ...
                    else if(field.getFigure(new Point(0, 1)) == Figure.X) return new Point(2, 0);
                }
            }
            ...
            if(field.getFigure(new Point(2, 0)) == Figure.X && field.getFigure(new Point(0, 2)) == null){
                ...
                else if(field.getFigure(new Point(0, 1)) == Figure.X) {
                    if(field.getFigure(new Point(1, 2)) == null) return new Point(1, 2);
                    else if(field.getFigure(new Point(1, 0)) == null) return new Point(1, 0);
                    else if(field.getFigure(new Point(1, 0)) == Figure.X) return new Point(0, 1);
                }
            }

            if(field.getFigure(new Point(1, 2)) == Figure.X || field.getFigure(new Point(1, 0)) == Figure.X) {
            ...
            if(field.getFigure(new Point(2, 1)) == Figure.X || field.getFigure(new Point(0, 1)) == Figure.X) {
                if(field.getFigure(new Point(2, 0)) == null) return new Point(2, 0);
        ...
        if(field.getFigure(new Point(0, 2)) == null && field.getFigure(new Point(2, 0)) == null) return new Point(0, 2);
        else if(field.getFigure(new Point(0, 2)) == Figure.O && field.getFigure(new Point(2, 0)) == null) return new Point(2, 0);
        else if(field.getFigure(new Point(0, 2)) == Figure.O && field.getFigure(new Point(2, 0)) == Figure.X) {

            if(field.getFigure(new Point(2, 2)) == Figure.X && field.getFigure(new Point(0, 0)) == null) {
                if(field.getFigure(new Point(2, 1)) == null) return new Point(2, 1);
                else if(field.getFigure(new Point(0, 1)) == null) return new Point(0, 1);
                else if(field.getFigure(new Point(0, 1)) == Figure.X) {
                    if(field.getFigure(new Point(1, 0)) == null) return new Point(1, 0);
                    else if(field.getFigure(new Point(1, 2)) == null) return new Point(1, 2);
                    else if(field.getFigure(new Point(1, 2)) == Figure.X) return new Point(0, 0);
                }
            }
            ...
            if(field.getFigure(new Point(0, 0)) == Figure.X && field.getFigure(new Point(2, 2)) == null){
                ...
                else if(field.getFigure(new Point(1, 2)) == Figure.X) {
                    if(field.getFigure(new Point(2, 1)) == null) return new Point(2, 1);
                    else if(field.getFigure(new Point(0, 1)) == null) return new Point(0, 1);
                    else if(field.getFigure(new Point(0, 1)) == Figure.X) return new Point(2, 2);
                }
            }
